...
import { IconEdit, IconCheck, IconX, IconRefresh, IconVideo, IconUpload, IconSpinner } from './Icons';
...
export function ShotEditor({ shot, onSave, onRegenerateImage, onUploadImage, onCreateVideo, imageLoading, uploading }: ShotEditorProps) {
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-indigo-400">镜头 {shot.display_index}</span>
            {!editing ? (
          ...
          {editing ? (
            <div className="space-y-3">
              <div>
                <label className="text-xs text-slate-400 block mb-1">镜头文案</label>
                <textarea
